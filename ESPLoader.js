...
class ESP8266ROM {
    ...
    static EFUSE_RD_REG_BASE = 0x3ff00050;
    ...
    static TEXT_START = 0x4010e000;
    static ENTRY = 0x4010e004;
    static DATA_START = 0x3fffaca8;
    static ROM_DATA = "" +
...
"bcqT/wWthFLmqB8AAA==";
    ...
    static get_chip_description = async (loader) => {
        ...
        var is_8285 = ((efuse0 & (1 << 4)) | (efuse3 & (1 << 16))) != 0;  // One or the other efuse bit is set for ESP8285
    ...
    static get_crystal_freq = async (loader) => {
        ...
        if (Math.abs(norm_xtal - ets_xtal) > 1) {
            loader.log("WARNING: Detected crystal freq " + ets_xtal + "MHz is quite different to normalized freq " + norm_xtal + "MHz. Unsupported crystal in use?");
        }
        return norm_xtal;
    }
    ...
    static read_mac = async (loader) => {
        ...
        mac1 = mac1 >>> 0;
        var mac3 = await this.read_efuse(loader, 3);
        mac3 = mac3 >>> 0;
